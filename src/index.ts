...
import verifyString from './verify-string';
...
const {argv} = yargs
    ...
    .command({
        command: "sign-string",
        describe: "Sign a string",
        handler: ({algorithm, input, privateKey, encoding, passphrase}) => {
            console.log(signString(algorithm, input, privateKey, encoding, passphrase));
        },
        builder: {
            algorithm: {
                alias: "a",
            ...
            input: {...input, description: "The string to sign"},
            privateKey: {
                ...input,
                alias: "priv",
                description: "The private key to sign with",
    ...
    .command({
        command: "verify-string",
        describe: "Verify a signature for a given string",
        handler: ({
                      algorithm,
                      input,
                      publicKey,
            ...
            console.log(
                verifyString(algorithm, input, publicKey, signature, signatureEncoding)
            );
        },
        builder: {
            algorithm: {
            ...
            input: {...input, description: "The string to verify"},
            publicKey: {
                ...input,
                alias: "pub",
                description: "The public key to verify against",
